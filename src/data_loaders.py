...
class GBSG2DataLoader(AbstractDataLoader):
    ...
    def load_data(self) -> Tuple[DataLoader, DataLoader, DataLoader, int]:
        ...
        df_train, df_test = train_test_split(df_onehot, test_size=0.15, random_state=42)
        df_train, df_val = train_test_split(df_train, test_size=0.15/0.85, random_state=42)
